...
import ${package}.${parentArtifactId}.domain.QUser;
...
@Service
@WebService(
        serviceName = "GreetServiceService",
        portName = "GreetServicePort",
        targetNamespace = "http://example.emstar.dk/greeting",
        wsdlLocation = "classpath:wsdl/dk.emstar.example.greeting.wsdl",
        endpointInterface = "dk.emstar.example.greeting.GreetService")
