...
import ${package}.infrastructure.domain.UserRepositoryBean;
import ${package}.services.msg.TextMessageListener;
import ${package}.services.msg.TextMessageUsingAdapterListener;
